...
import { FaBookOpen, FaBook, FaLightbulb, FaBookmark } from "react-icons/fa";
...
export const RightSide = () => (
  <>
    ...
    <div className="absolute bottom-20 right-10 animate-book-flip">
      <FaBookmark size={40} className="text-white opacity-80" />
    </div>
    <div className="absolute top-1/2 left-1/4 animate-glow">
    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center px-12">
      ...
      >
        Create your account and start exploring a world of knowledge and
        imagination with us.
      </p>
    </div>
  </>
